...
TEST(ordenarRegionYCODUSUTEST, unSoloHogarYUnSoloIndividuo) {
    ...
    //expect_ordenarRegionYTipo_no_cambia_nada(th, ti);
    EXPECT_EQ(th, th);
    EXPECT_EQ(ti, ti);
}
...
TEST(ordenarRegionYCODUSUTEST, noCambiaNada) {
...
TEST(ordenarRegionYCODUSUTEST, unHogConDosHabitantes) {

    eph_h th = {
            {334,  2017, 1, 1, 1, 0, 1, 4, 1, 2},
    };
...
TEST(ordenarRegionYCODUSUTEST, unHogConTresIndividuosHabitantesDesordenadosEnMayorAMenor) {
    ...
    eph_i ti = {
            {334, 3, 2017, 1, 0, 1, 36, 1, 3, 16300, 1 },
            {334, 2, 2017, 1, 0, 1, 36, 1, 3, 16300, 1 },
            {334, 1, 2017, 1, 0, 1, 36, 1, 3, 16300, 1 },
    };
...
TEST(ordenarRegionYCODUSUTEST, unHogConTresIndividuosHabitantesDesordenadosAlAzar) {
